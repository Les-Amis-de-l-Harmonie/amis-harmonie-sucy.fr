...
const partners = [
  ...
  {
    src: "/images/logo-confrerie.jpeg",
    alt: "Confrérie des Côteaux de Sucy",
    px: true,
  },
...
const Partenaires = () => (
  <Layout
    title="Partenaires - Les Amis de l'Harmonie de Sucy-en-Brie"
    description="Découvrez nos partenaires institutionnels, associatifs et commerciaux qui soutiennent l'Harmonie Municipale de Sucy-en-Brie. La Ville de Sucy-en-Brie, la Confédération Musicale de France, les commerçants locaux et autres acteurs contribuent au succès de nos événements musicaux. Envisagez de nous rejoindre en tant que partenaire pour promouvoir la culture et la musique dans notre commune."
  >
    <div className="py-16">
          ...
          <div className="w-full">
            <div className="flex flex-wrap justify-center gap-4">
              {partners.map((partner, index) => (
                <div
                  key={index}
                  className="flex w-1/2 sm:w-1/3 md:w-1/8 items-center"
                >
                  <ExportedImage
