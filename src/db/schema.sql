...
CREATE TABLE IF NOT EXISTS users (
  ...
  role TEXT NOT NULL CHECK(role IN ('ADMIN', 'MUSICIAN')),
...
CREATE INDEX IF NOT EXISTS idx_videos_publication_date ON videos(publication_date);
CREATE INDEX IF NOT EXISTS idx_guestbook_date ON guestbook(date);
CREATE INDEX IF NOT EXISTS idx_contact_submissions_created_at ON contact_submissions(created_at);
CREATE INDEX IF NOT EXISTS idx_auth_tokens_expires_at ON auth_tokens(expires_at);
CREATE INDEX IF NOT EXISTS idx_sessions_expires_at ON sessions(expires_at);
CREATE INDEX IF NOT EXISTS idx_sessions_session_id ON sessions(session_id);
CREATE INDEX IF NOT EXISTS idx_gallery_category ON gallery_images(category);
CREATE INDEX IF NOT EXISTS idx_gallery_sort_order ON gallery_images(category, sort_order);
