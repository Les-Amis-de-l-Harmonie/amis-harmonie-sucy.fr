...
export function Publications() {
  return (
    <>
      ...
      <meta name="description" content="Suivez l'actualité de l'Harmonie Municipale de Sucy-en-Brie sur Instagram. Photos, vidéos et moments forts de nos événements musicaux." />
      <meta property="og:title" content="Publications Instagram | Les Amis de l'Harmonie de Sucy" />
      <meta property="og:description" content="Suivez l'actualité de l'Harmonie Municipale de Sucy-en-Brie sur Instagram." />
          ...
          <Suspense
            fallback={
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-gray-100 dark:bg-gray-800 rounded-xl h-[500px] animate-pulse" />
                ))}
              </div>
            }
          >
