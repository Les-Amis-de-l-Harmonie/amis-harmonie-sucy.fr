export function Harmonie() {
  ...
  return (
    <>
      ...
      <meta name="description" content="Découvrez l'Harmonie Municipale de Sucy-en-Brie, orchestre de 35 musiciens fondé il y a plus de 150 ans. Rejoignez-nous pour partager notre passion de la musique." />
