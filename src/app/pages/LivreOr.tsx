...
export function LivreOr() {
  return (
    <>
      ...
      <meta
        name="description"
        content="Découvrez les témoignages de notre public et partagez votre expérience avec l'Harmonie Municipale de Sucy-en-Brie."
      />
      <meta property="og:title" content="Livre d'Or | Les Amis de l'Harmonie de Sucy" />
      <meta
        property="og:description"
        content="Découvrez les témoignages de notre public et partagez votre expérience."
      />
            ...
            fallback={
              <div className="max-w-2xl mx-auto space-y-6">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="bg-gray-100 dark:bg-gray-800 rounded-xl h-32 animate-pulse"
                  />
                ))}
              </div>
            }
