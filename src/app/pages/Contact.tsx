...
export function Contact() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Contactez Les Amis de l'Harmonie de Sucy-en-Brie. Posez vos questions, demandez des informations sur nos événements ou rejoignez notre association."
      />
