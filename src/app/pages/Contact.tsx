        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mb-12">
            ...
            <Button
              ...
              className="w-full py-3 bg-gradient-to-r from-[#a5b3e2] to-[#e8b4c8] text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
            >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 text-center">
            <a href="tel:0783511741" className="flex items-center gap-2 text-[#a5b3e2] hover:underline">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              07 83 51 17 41
            </a>
            <a href="mailto:contact@amis-harmonie-sucy.fr" className="flex items-center gap-2 text-[#a5b3e2] hover:underline">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              contact@amis-harmonie-sucy.fr
            </a>
          </div>
        </div>
      </div>
