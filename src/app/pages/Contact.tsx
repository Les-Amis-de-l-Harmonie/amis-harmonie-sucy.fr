      ...
      <div className="py-12">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="tel:0783511741"
              className="flex-1 flex h-[100px] items-center justify-center rounded border border-gray-200 dark:border-gray-700 p-4 text-primary hover:border-primary transition-colors"
            >
            ...
            >
              ...
              <span className="text-lg font-bold text-gray-900 dark:text-gray-100">contact@amis-harmonie-sucy.fr</span>
            </a>
          </div>
        </div>
      </div>
